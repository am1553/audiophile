...
function Header() {
  return (
    <header className='fixed h-24 flex items-center justify-between px-10 w-full max-w-7xl left-[50%] -translate-x-[50%] border-b-[1px] border-b-grey border-opacity-20 z-10'>
